...
def main():
    ...
    if args.weights != 0:
        ...
        logger = create_logger(args.path_helper['log_path'], phase='train')
    ...
    print("len(nice_train_loader) =", len(nice_train_loader))
    print("len(nice_test_loader) =", len(nice_test_loader))
    print("train dataset size =", len(nice_train_loader.dataset))
    print("test dataset size =", len(nice_test_loader.dataset))
