...
def get_dataloader(args):
    ...
    if args.dataset == 'isic':
        ...
        '''kits data'''
        kits_train_dataset = KITS(args, data_path = args.data_path, transform = transform_train, transform_msk= transform_train_seg, mode = 'Training')
        kits_test_dataset = KITS(args, data_path = args.data_path, transform = transform_test, transform_msk= transform_test_seg, mode = 'Test')

        nice_train_loader = DataLoader(kits_train_dataset, batch_size=args.b, shuffle=True, num_workers=8, pin_memory=True)
        nice_test_loader = DataLoader(kits_test_dataset, batch_size=args.b, shuffle=False, num_workers=8, pin_memory=True)
        '''end'''
