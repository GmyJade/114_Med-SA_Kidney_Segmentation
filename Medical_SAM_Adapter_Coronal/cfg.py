...
def parse_args():    
    ...
    parser.add_argument('-plane', default=None, choices=['axial', 'sagittal', 'coronal'], help='2D slicing plane for volumetric datasets')
    ...
    parser.add_argument(
        ...
        help='2D slice direction for 3D NIfTI datasets such as kits')
    parser.add_argument(
    '-data_path',
    type=str,
    default='../data',
